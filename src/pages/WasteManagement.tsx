          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-orange-700 dark:text-orange-300">Volume</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-red-700 dark:text-red-300">Health Impacts</p>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-green-700 dark:text-green-300">Ecological Degradation</p>
                  <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-blue-700 dark:text-blue-300">Economic Costs</p>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-purple-700 dark:text-purple-300">Feedback Failures</p>
                  <p className="text-sm text-muted-foreground">
